...
#打包exe
#pyinstaller ./20210709_ScrapingScript_GreenJapan.py -D --clean --noconsole -n "ScrapingTool" -i fav.ico --add-binary "./driver/chromedriver.exe;./driver" --add-binary "./browser;./browser"
...
def get_tar():
    ...
    if var_path.get()=="":
        ...
        #jupyter用
        #window_savepath="pandas_to_excel.xlsx"
    else:
        window_savepath = var_path.get()+"/pandas_to_excel.xlsx"
